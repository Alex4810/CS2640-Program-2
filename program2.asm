...
dGrade: .asciiz "D\n"
fGrade: .asciiz "F\n"
invalidInputError: .asciiz "Invalid input. Please enter a score between 0 and 100.\n"
...
gradeA:
    li $v0, 4               # Load system call code for printing string
    la $a0, resultMessage1   # Load address of the result message
    syscall
    li $v0, 4               # Load system call code for printing string
    la $a0, aGrade
    syscall
